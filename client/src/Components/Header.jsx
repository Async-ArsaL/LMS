    ...
    <nav className="bg-gradient-to-br from-white to-blue-100 shadow-lg">
      <div className="max-w-7xl mx-auto px-4">
        <div className="flex justify-between items-center h-16">
          <div className="flex-shrink-0 w-36 center mt-2">
            {/* <Link to="/" className="text-2xl font-bold">Logo</Link> */}
            <img src="https://anywhere.learn.co.th/main/wp-content/uploads/2020/01/Learncorp_Logo_Pack_2021_Learn-Anywhere-Primary-RGB.png" alt="" />
          </div>
